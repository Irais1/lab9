$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        $("#question1-feedback").append("This answer is <strong>1994</strong>" );
        // Question 2
        if(answer2==="C"){
        ...
        $("#question3-feedback").append("The answer is <strong>25</strong>");
        ...
        $("#question4-feedback").append("The answer is <strong>7</strong>");
